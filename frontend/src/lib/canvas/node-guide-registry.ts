...
import { PADDLE_DOCLAYOUT_S_NODE_GUIDE } from "@/components/canvas/node-guide/guides/paddle-doclayout-s-node-guide";
import { PADDLE_OCR_V6_SMALL_NODE_GUIDE } from "@/components/canvas/node-guide/guides/paddle-ocr-v6-small-node-guide";
import { PADDLE_PP_STRUCTURE_NODE_GUIDE } from "@/components/canvas/node-guide/guides/paddle-pp-structure-node-guide";
...
export const NODE_GUIDE_REGISTRY: Record<string, NodeGuideDefinition> = {
  ...
  [PADDLE_DOCLAYOUT_S_NODE_GUIDE.modelId]: PADDLE_DOCLAYOUT_S_NODE_GUIDE,
  [PADDLE_OCR_V6_SMALL_NODE_GUIDE.modelId]: PADDLE_OCR_V6_SMALL_NODE_GUIDE,
  [PADDLE_PP_STRUCTURE_NODE_GUIDE.modelId]: PADDLE_PP_STRUCTURE_NODE_GUIDE,
};
