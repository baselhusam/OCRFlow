...
type AdminUsersLeaderboardProps = {
...
export function AdminUsersLeaderboard({ users }: AdminUsersLeaderboardProps) {
  ...
  return (
    <div>
      <AdminSectionHeading
        title="Top users"
        subtitle="by run volume in selected range"
      />
                    ...
                    <div className="flex min-w-0 items-center gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="truncate font-mono text-[11px] text-muted-foreground">
                          {item.email} · {getRoleLabel(item.role as "admin" | "view_admin" | "user")}
                        </p>
                      </div>
                    </div>
                  </TableCell>
